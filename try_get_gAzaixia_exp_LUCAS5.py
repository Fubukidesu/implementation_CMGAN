import torch
import numpy as np
from lgn_module_Azaixia import LGNGenerator_Azaixia_5
...
adj_A = np.zeros((5, 5))
attrs_default = [
   'Smoking	Genetics	Fatigue	Coughing	Lung_cancer'
]

def get_A():
    # 得到A的数值
    generator = LGNGenerator_Azaixia_5(adj_A).cuda()
    generator.load_state_dict(torch.load('output/exp_models/lgn_model_LUCAS5/6_generator.pth'))
...
# [[ 0.      0.0005 -0.0002  0.0013  0.0234]
#  [-0.0017  0.      0.0017 -0.0118 -0.0013]
#  [ 0.0024  0.0003 -0.      0.0002 -0.0011]
#  [-0.0003  0.0002 -0.0045 -0.     -0.0011]
#  [-0.0002 -0.0023 -0.0003  0.0003 -0.    ]]
# get_A()
