...
for step_k in range(20):  # 为了找lambda和c而进行迭代
    while c_A < 1e+20:  # 当c_a小于1e+20时不断增大c_A
        ...
        adj_A1 = train(lgngenerator, lgndiscriminator, train_data, val_data, 'output/exp_models/lgn_model_celebA9fromCAN/%s_generator.pth'%step_k, 'output/exp_models/lgn_model_celebA9fromCAN/%s_discriminator.pth'%step_k, 'output/exp_models/lgn_model_celebA9fromCAN/%s_loss.csv'%step_k, lambda_A, c_A)
