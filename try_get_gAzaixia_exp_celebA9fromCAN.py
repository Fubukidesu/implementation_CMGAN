...
def get_A():
    ...
    generator.load_state_dict(torch.load('output/exp_models/lgn_model_celebA9fromCAN/9_generator.pth'))
...
#     [[-0.      0.0001 -0.0006 -0.0009 -0.0004 -0.0001  0.0011 -0.      0.    ]
#  [-0.0086  0.      0.0061  0.0087  0.0006 -0.0124  0.0034 -0.0186  0.001 ]
#  [ 0.0017 -0.0001  0.     -0.0003  0.0001  0.0004  0.0083 -0.0001  0.0002]
#  [ 0.0001  0.0002 -0.0007  0.     -0.     -0.0013 -0.008   0.     -0.0017]
#  [-0.0029 -0.0003  0.0012  0.0058  0.     -0.0033 -0.0067  0.0259  0.0022]
#  [ 0.0016 -0.      0.0006  0.0018  0.0001  0.     -0.0123 -0.0124 -0.0031]
#  [ 0.0002  0.0002  0.0006 -0.0001  0.      0.0003 -0.     -0.0057  0.0055]
#  [-0.005   0.      0.0064  0.0043  0.      0.     -0.0004  0.     -0.0001]
#  [-0.0007  0.0002 -0.0047 -0.0005  0.0006 -0.      0.0005  0.0126 -0.    ]]
# get_A()
...
def get_VecBeforeA():
    ...
    print('gen_features', np.around(gen_features.cpu().detach().numpy(), decimals=2))
