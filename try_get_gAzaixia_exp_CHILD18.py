import torch
import numpy as np
from lgn_module_Azaixia import LGNGenerator_Azaixia_18
...
adj_A = np.zeros((18, 18))
attrs_default = [
#    BirthAsphyxia	HypDistrib	HypoxiaI02	CO2	ChestXray	
# Grunting	LVHreport	CO2Report	XrayReport	Disease	
...
def get_A():
    # 得到A的数值
    generator = LGNGenerator_Azaixia_18(adj_A).cuda()
    generator.load_state_dict(torch.load('output/exp_models/lgn_model_CHILD18/10_generator.pth'))
...
# [[-0.     -0.0058 -0.0022 -0.     -0.0025  0.0002 -0.0004 -0.002   0.
#    0.0035  0.      0.0021 -0.      0.0016  0.     -0.0015 -0.0017  0.0003]
#  [ 0.      0.      0.0021 -0.0001 -0.0015 -0.     -0.0001 -0.      0.0008
#   -0.001  -0.     -0.0026 -0.001  -0.0005 -0.0514  0.0016 -0.0014 -0.0024]
#  [ 0.     -0.0001 -0.      0.0007  0.0025  0.0001  0.      0.     -0.0027
#    0.      0.0009  0.      0.0001  0.     -0.     -0.0008  0.0008 -0.0005]
#  [-0.0027 -0.0001  0.0001  0.     -0.0027  0.0001  0.0002  0.0039 -0.0022
#   -0.0008  0.0012 -0.      0.0007  0.0038 -0.      0.0031  0.0001  0.0032]
#  [ 0.     -0.      0.     -0.      0.      0.0001 -0.0011  0.0004 -0.0081
#    0.0008  0.0001  0.0019 -0.      0.0015 -0.0001  0.0001  0.0001 -0.0018]
#  [-0.0008 -0.0029 -0.0011 -0.002  -0.0011  0.      0.0003  0.0001  0.0018
#    0.0001  0.     -0.0001 -0.0001  0.     -0.0002 -0.0013  0.0015 -0.0018]
#  [ 0.0001  0.0004  0.0023  0.0002 -0.0001  0.0005  0.      0.0008 -0.0016
#   -0.     -0.005   0.     -0.      0.0013 -0.0016 -0.0001 -0.0011 -0.0029]
#  [ 0.0001  0.0006  0.0023  0.     -0.0004 -0.0022  0.0003  0.     -0.0002
#   -0.0027  0.0004  0.0024 -0.0021  0.0016 -0.0008 -0.0003  0.0001  0.0004]
#  [ 0.0016 -0.0001  0.     -0.     -0.0001  0.0001 -0.     -0.     -0.
#    0.0001  0.0007  0.0022 -0.0004 -0.001  -0.      0.0001 -0.      0.0011]
#  [ 0.     -0.      0.0058 -0.     -0.     -0.0008  0.0022  0.     -0.0004
#   -0.     -0.0003  0.0001 -0.      0.0041  0.0107 -0.0031  0.0001 -0.0021]
#  [-0.0026  0.0032  0.0001 -0.0001 -0.0009 -0.0032  0.      0.0007  0.0004
#    0.0008  0.     -0.0032  0.      0.0005  0.0001 -0.0029 -0.      0.0022]
#  [ 0.     -0.      0.0016  0.0021  0.      0.0021  0.0004  0.0001  0.
#   -0.0004  0.      0.      0.0012  0.      0.003   0.0038  0.0028  0.    ]
#  [ 0.0007 -0.      0.0007  0.0003 -0.0013  0.001  -0.0035  0.      0.0003
#    0.0024  0.0027  0.      0.      0.0027 -0.      0.0002  0.0006  0.    ]
#  [ 0.0001  0.0006 -0.0006 -0.     -0.     -0.0045  0.0001  0.     -0.0004
#   -0.0001  0.0005 -0.0032 -0.      0.     -0.      0.0006  0.0003  0.0014]
#  [ 0.0009 -0.     -0.0008  0.0016 -0.0003  0.0003  0.0001  0.0003  0.0025
#    0.0001  0.0004 -0.     -0.0017  0.0012  0.      0.0001 -0.      0.0003]
#  [-0.     -0.0001  0.0003 -0.     -0.0002  0.0002  0.0001 -0.0007  0.0013
#   -0.      0.     -0.     -0.0003  0.0006 -0.001  -0.      0.      0.0024]
#  [ 0.0001 -0.0001  0.0003  0.0007 -0.0011  0.0001 -0.0002 -0.0007  0.0002
#    0.0008  0.0003 -0.     -0.      0.0009 -0.0028  0.003   0.      0.0012]
#  [-0.0012 -0.      0.0004  0.0002  0.      0.0001  0.      0.0003 -0.
#   -0.      0.0001  0.0016 -0.0024  0.     -0.0003  0.      0.      0.    ]]
# get_A()
...
def get_VecBeforeA():
    ...
    noise = Variable(torch.FloatTensor(10, 10).normal_())
    noise = to_cuda_if_available(noise)
    gen_features, adj_A1, output_10, Wa = generator(noise, training=True)
    print('Vec', np.around(output_10.cpu().detach().numpy(), decimals=3))
    print('Wa', Wa.cpu().detach().numpy())
# get_VecBeforeA()
