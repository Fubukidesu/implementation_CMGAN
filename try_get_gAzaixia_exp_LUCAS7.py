import torch
import numpy as np
from lgn_module_Azaixia import LGNGenerator_Azaixia_7
...
adj_A = np.zeros((7, 7))
attrs_default = [
   'Smoking	Anxiety	Genetics	Attention_Disorder	Car_Accident	Fatigue	Lung_cancer'
]

def get_A():
    # 得到A的数值
    generator = LGNGenerator_Azaixia_7(adj_A).cuda()
    generator.load_state_dict(torch.load('output/exp_models/lgn_model_LUCAS7/6_generator.pth'))
...
# normal
# [[ 0.      0.0011 -0.      0.     -0.      0.      0.    ]
#  [ 0.0002  0.      0.      0.0006  0.0017  0.0003  0.0008]
#  [ 0.0029 -0.0027  0.     -0.     -0.0026  0.     -0.    ]
#  [ 0.0009 -0.0001 -0.0027 -0.      0.0002  0.0033 -0.0036]
#  [-0.0029 -0.     -0.      0.0002 -0.     -0.0009  0.0029]
#  [ 0.003  -0.0002 -0.0022 -0.     -0.      0.      0.0015]
#  [-0.0019  0.     -0.0031  0.     -0.     -0.      0.    ]]
# uniform
# [[ 0.      0.     -0.0018  0.     -0.0028  0.     -0.    ]
#  [-0.0029 -0.     -0.002  -0.0013  0.003  -0.      0.    ]
#  [ 0.     -0.     -0.     -0.      0.0014  0.0009  0.0002]
#  [-0.0023  0.     -0.003  -0.     -0.0003 -0.0001 -0.    ]
#  [ 0.      0.     -0.     -0.0002  0.      0.0002  0.0029]
#  [-0.0029 -0.0013  0.0001  0.0003 -0.0005  0.     -0.0012]
#  [-0.0014 -0.002   0.0004  0.0029  0.     -0.     -0.    ]]
# get_A()
