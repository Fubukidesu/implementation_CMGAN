...
adj_A = np.zeros((9, 9))
attrs_default = [
   'Smoking	Anxiety	Genetics	Attention_Disorder	Car_Accident	Fatigue	Allergy	Coughing	Lung_cancer'
]

def get_A():
    # 得到A的数值
    generator = LGNGenerator_Azaixia(adj_A).cuda()
    generator.load_state_dict(torch.load('output/exp_models/lgn_model_LUCAS9/6_generator.pth'))
...
# [[-0.      0.0015 -0.0003 -0.0001  0.0071 -0.0005  0.002  -0.0011 -0.0009]
#  [ 0.003   0.     -0.0001  0.0001 -0.0003 -0.0008 -0.0005 -0.0012 -0.0025]
#  [-0.0021 -0.0087 -0.      0.0134 -0.0009 -0.0012  0.0159  0.0011 -0.0013]
#  [ 0.0108  0.0054  0.0001  0.     -0.0108 -0.0007 -0.0012  0.0003 -0.0026]
#  [-0.0001 -0.001   0.0008  0.0001  0.     -0.0008 -0.0012  0.0007  0.0011]
#  [ 0.0036  0.0003 -0.0021  0.0065  0.0014  0.      0.0001  0.0146 -0.0007]
#  [ 0.001   0.0015 -0.      0.0005  0.0003 -0.0145 -0.     -0.0022  0.0001]
#  [ 0.001   0.0001 -0.0006  0.0007  0.0001  0.      0.0005  0.     -0.0006]
#  [ 0.0011 -0.0004  0.0001  0.0016 -0.0007  0.0019  0.0045  0.0007  0.    ]]
# get_A()
